...
def main():
    ...
    model.compile(optimizer=adam, loss=loss_method, metrics=['mse', 'acc'])  # <==<==biogpu12-1
    ...
    print("Traning Model...")
    model.fit(x_train, y_train, batch_size=batch_size, epochs=epochs, verbose=2, callbacks=callbacks_list,
